...
const icons = {
  ...
  stickers: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true"><path d="M12 3l2.4 5 5.6.7-4.1 3.8 1.1 5.5-5-2.7-5 2.7 1.1-5.5L4 8.7 9.6 8z" /></svg>,
...
const groups = [
  {
    ...
    links: [
      ...
      { to: '/admin/stickers', label: 'Sticker', icon: icons.stickers },
