...
export default function AdminDrawer({ open, title, onClose, children }: AdminDrawerProps) {
  ...
  return (
    <dialog
      ...
      className="admin-drawer m-0 ml-auto h-dvh max-h-none w-[min(100vw,560px)] max-w-none border-0 bg-admin-bg p-0 text-admin-ink shadow-2xl backdrop:bg-admin-sidebar/60"
    >
